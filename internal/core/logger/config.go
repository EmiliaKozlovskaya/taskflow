...
type Config struct {
	Level  string `envconfig: "LEVEL" required: "true"` //envconfig - библиотека, которая позволяет загружать значения из переменных окружения в структуру. required: "true" - поле обязательно.
